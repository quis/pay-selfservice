...
module.exports = (req, res) => {
  ...
  filters.result.newChargeStatusEnabled = req.user.hasFeature(NEW_CHARGE_STATUS_FEATURE_HEADER)
  transactionService
    ...
    .then(transactions => {
      client
        .getAllCardTypes({correlationId}, allCards => {
          ...
          model.eventStates = states.getStateFilters(req.user.hasFeature(NEW_CHARGE_STATUS_FEATURE_HEADER))
          // model.eventStates = states.new_states()
